...
function pqrc_settings_init(){
    ...
    add_settings_field('pqrc_extra',__('QR Extra','posts-to-qrcode'),'pqrc_display_field','general','pqrc_section',array('pqrc_extra'));
...
function pqrc_display_toggle_field(){
    ...
    printf("<input type='hidden' name='pqrc_toggle' id='pqrc_toggle' value='".$option."'/>");
}
...
function pqrc_section_callback(){
    echo "<p>".__('Setting for Posts To QR Plugin','posts-to-qrcode')."</p>";
}
